...
# instead of connecting to the database directly we will instead create session
# create a new of instance of sessionmaker, then point to our engine (the db)
Session = sessionmaker(db)

# opens an sctual session by calling the Session() subclass above
session = Session()

# creating the database from the declarative_base subclass
